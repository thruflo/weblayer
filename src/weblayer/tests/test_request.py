...
class TestRequestHandler(unittest.TestCase):
    ...
    def test_get_raises_notimplemented(self):
        """ Calling `self.get` raises a `NotImplementedError`.
        """
        
        handler = self.make_one()
        self.assertRaises(
            NotImplementedError,
            handler.get
        )
    ...
    def test_get_accepts_args(self):
        """ Calling `self.get` with args doesn't raise a `TypeError`.
        """
    ...
    def test_get_doesnt_accept_kwargs(self):
        """ Calling `self.get` with kwargs raises a `TypeError`.
        """
    ...
    def test_head_raises_notimplemented(self):
        """ Calling `self.head` raises a `NotImplementedError`.
        """
    ...
    def test_head_accepts_args(self):
        """ Calling `self.head` with args doesn't raise a `TypeError`.
        """
    ...
    def test_head_doesnt_accept_kwargs(self):
        """ Calling `self.head` with kwargs raises a `TypeError`.
        """
